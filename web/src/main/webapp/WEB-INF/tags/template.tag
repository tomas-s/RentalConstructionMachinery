    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="/shopping/show"><f:message key="navigation.eshop"/></a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><f:message key="navigation.admin"/><b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="/order/list/all"><f:message key="navigation.admin.orders"/></a></li>
                        <li><a href="/user/list"><f:message key="navigation.admin.customers"/></a></li>
                        <li><a href="/product/list"><f:message key="navigation.admin.products"/></a></li>
                        <li><a href="/category/list"><f:message key="navigation.admin.categories"/></a></li>
                    </ul>
                </li>
                <li class="dropdown">
...
<div class="container">
    ...
    <!-- footer -->
    <footer class="footer">
        <p>&copy;&nbsp;2015 &nbsp;Masaryk University</p>
    </footer>
</div>
